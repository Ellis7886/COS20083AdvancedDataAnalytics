...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    ...
                                    max=10000,  # Maximum value of the slider, set to a fixed value for example
                                    step=1000,  # Step size
                                    marks={i: '{} Kg'.format(i) for i in range(0, 11000, 1000)},
                                    value=[min_payload, max_payload],  # Default value of the slider
                                    ),
...
def update_scatter_chart(entered_site, payload_range):
    ...
    fig = px.scatter(
        filtered_df, x='Payload Mass (kg)',
        y='class', 
        color='Booster Version Category',
        title='Mission Outcomes by Payload Mass and Booster Version',
